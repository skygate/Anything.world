...
export const MintButton = ({
  ...
  useEffect(() => {
    ...
    mintButton.addEventListener("click", whitelistMint);

    return () => mintButton.removeEventListener("click", whitelistMint);
  });

  useEffect(() => {
    //@ts-ignore
    const mintButton: HTMLButtonElement =
      document.getElementsByClassName("minting")[0];
    if (isMinting || !isActive) mintButton.disabled = true;
  }, [isMinting, isActive]);
